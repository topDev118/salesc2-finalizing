<?php $__env->startSection('content'); ?>
    ...
    <section class="images-section">
        <div class="container">
            ...
            <div class="row p-t-b">
                <div class="col-md-7 col-sm-6 p-t-b-para">
...
<?php echo $__env->make('layouts.frontLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\MyWORK\laravel\resources\views/frontend/home.blade.php ENDPATH**/ ?>