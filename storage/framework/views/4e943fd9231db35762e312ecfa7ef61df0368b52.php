    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container" >
            ...
            <div id="navbar" class="collapse navbar-collapse navbar-right" style="display:flex!important;">
                ...
                <button onclick="location.href = '<?php echo e(URL::asset('admin/dashboard')); ?>'" type="button" name="" value="" class="login-btn mobile-admin">Admin Panel</button>                                
                <?php endif; ?>
...
<?php /**PATH F:\MyWORK\laravel\resources\views/dashboard/dashboardHeader.blade.php ENDPATH**/ ?>