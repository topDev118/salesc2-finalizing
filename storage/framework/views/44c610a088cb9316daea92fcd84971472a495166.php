        ...
        <div class="col-md-auto">
            <table id="datatable" class="table table-striped table-bordered" style="color:black;font-family:'sans-serif'">
                ...
                <tbody>
                    ...
                    <tr>
                        <td ><?php echo e($accounts->customer); ?></td>
                        <td ><?php echo e($accounts->department); ?></td>
                        <td ><?php echo e($accounts->address); ?></td>
                        <td ><?php echo e($accounts->city); ?></td>
                        <td ><?php echo e($accounts->state); ?></td>
                        <td ><?php echo e($accounts->pocname); ?></td>
                        <td ><?php echo e($accounts->phone); ?></td>
                        <td ><?php echo e($accounts->email); ?></td>
                        <td >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboardLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\MyWORK\laravel\resources\views/dashboard/accounts.blade.php ENDPATH**/ ?>