    ...
    <div class="modal fade" id="myLogin" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="true">
        ...
        <div class="modal-dialog modal-md loginmodalbox login-modal" style="font-family:none">
...
if (isset($messageCache)) { $message = $messageCache; }
                ...
                <div class="login-form-2 registerBox" style="display:none;">
                    ...
                    <form method="POST" class="register-form" id="login-form" action="<?php echo e(route('register')); ?>">
                        ...
                        <label for="remember_me">By registering you confirm that you accept the <a href="<?php echo e(URL::asset('privacy-policy')); ?>" style="color:#aab5cf;">Privacy Policy</a></label>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModal" aria-hidden="true">
    ...
    <?php endif; ?>   
<?php /**PATH F:\MyWORK\laravel\resources\views/frontend/header.blade.php ENDPATH**/ ?>