...
$sql_queries['getRecentGroupMessages'] = "select * from cometchat_chatroommessages where id in (select max(id) from cometchat_chatroommessages where cometchat_chatroommessages.chatroomid in ({joinedrooms}) group by chatroomid)";
